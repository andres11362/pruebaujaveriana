$('#registro').click(function (e){ //indicamos el evento del boton con el id registro
    var $dato = $('#nombre').val();
    var $dpto = $('#dpto').val(); //definimos los valores en los controles
    var $route = 'http://localhost:8000/municipio'; //indicamos la ruta del controlador en este caso de creacion
    ...
    $.ajax({ //iniciamos la peticion ajax
        ...
        data: {nombre: $dato, departamento_id: $dpto},  //datos que se envian
        success: function () {
